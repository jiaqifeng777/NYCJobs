...
NYC Housing Authority has the most missing values for "Preferred Skills" and Police Department has the least. This is informative as police department have specific skill requirements due to its job nature, while housing authority might not，so the values for "Preferred Skills" tend to be missing on job postings.
