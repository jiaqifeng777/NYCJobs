...
## Cleaning / transformation
  ...
  Since there are 30 columns in this dataset, we need to first remove the columns with no pivotal information such as **Title.Code.No*</mark >**. The remaining columns are the 16 columns below:
